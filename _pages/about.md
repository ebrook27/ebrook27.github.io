...
**Research Interests**:
- **Public health:** county-level modeling of opioid overdose mortality, longitudinal risk stratification, and counterfactual policy simulations targeting prescribing practices and social determinants of health.
  
- **Advanced manufacturing:** time-series and state-space modeling (e.g., EKF-style approaches) for real-time temperature prediction and process monitoring in additive manufacturing.
